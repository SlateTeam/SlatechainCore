                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PBS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PBS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pbs: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PBS Core"), this);
    aboutAction->setStatusTip(tr("Show information about PBS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PBS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PBS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PBS addresses"));
    ...
    openAction->setStatusTip(tr("Open a PBS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PBS Core help message to get a list with possible PBS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PBS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PBS network", "", count));
}
...
{
    QString strTitle = tr("PBS Core"); // default title
