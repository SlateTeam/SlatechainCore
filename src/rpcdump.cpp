...
Value importprivkey(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "importprivkey \"slatechainprivkey\" ( \"label\" rescan )\n"
            "\nAdds a private key (as returned by dumpprivkey) to your wallet.\n"
            "\nArguments:\n"
            "1. \"slatechainprivkey\"   (string, required) The private key (see dumpprivkey)\n"
...
Value dumpprivkey(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"slatechainaddress\"\n"
            "\nReveals the private key corresponding to 'slatechainaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"slatechainaddress\"   (string, required) The slatechain address for the private key\n"
            "\nResult:\n"
...
Value bip38encrypt(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"slatechainaddress\"\n"
            "\nEncrypts a private key corresponding to 'slatechainaddress'.\n"
            "\nArguments:\n"
            "1. \"slatechainaddress\"   (string, required) The slatechain address for the private key (you must hold the key already)\n"
...
Value bip38decrypt(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38decrypt \"slatechainaddress\"\n"
