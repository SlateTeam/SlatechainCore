...
//! These need to be macros, as clientversion.cpp's and slatechain*-res.rc's voodoo requires it
...
/**
 * slatechaind-res.rc includes this file, but it cannot cope with real c++ code.
