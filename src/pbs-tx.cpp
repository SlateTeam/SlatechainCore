...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SLTC Core slatechain-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  slatechain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded slatechain transaction") + "\n" +
                               "  slatechain-tx [options] -create [commands]   " + _("Create hex-encoded slatechain transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded slatechain transaction
