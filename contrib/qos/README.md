...
This means one can have an always-on pbsd instance running, and another local pbsd/pbs-qt instance which connects to this node and receives blocks from it.
