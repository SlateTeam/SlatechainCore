...
This mechanism has been integrated into Bitcore-Node-PBS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PBS-Project/insight-api-pbs#web-socket-api](https://github.com/PBS-Project/insight-api-pbs#web-socket-api) 
* API: [https://github.com/PBS-Project/insight-api-pbs#swifttx-transactions](https://github.com/PBS-Project/insight-api-pbs#swifttx-transactions) 
...
By default, the PBS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PBS Core daemon:
