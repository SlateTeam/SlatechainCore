...
In order to support loading of multiple wallets in pbs-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pbs.cpp.
...
Changes to pbs.cpp
----------------------
pbs.cpp is the entry point into pbs-qt, and as such, will require some minor modifications to provide hooks for
