...
In order to support loading of multiple wallets in slatechain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is slatechain.cpp.
...
Changes to slatechain.cpp
----------------------
slatechain.cpp is the entry point into slatechain-qt, and as such, will require some minor modifications to provide hooks for
